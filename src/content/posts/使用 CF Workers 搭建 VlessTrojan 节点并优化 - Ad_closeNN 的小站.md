...
## 前言[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E5%89%8D%E8%A8%80)
...
> 
> ```css
> 1(j) use the Services to provide a virtual private network or other similar proxy services.2--- Google Translate:3(j) 使用服务提供虚拟专用网络或其他类似的代理服务。
> ```
...
## 需求[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E9%9C%80%E6%B1%82)

1.  一个域名（免费/付费）
2.  一个 [Cloudflare](https://dash.cloudflare.com/) 账号

## 关于域名[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E5%85%B3%E4%BA%8E%E5%9F%9F%E5%90%8D)
...
## 搭建节点[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E6%90%AD%E5%BB%BA%E8%8A%82%E7%82%B9)
...
## 创建 Worker[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E5%88%9B%E5%BB%BA-worker)
...
## 编辑 Worker[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E7%BC%96%E8%BE%91-worker)
...
```perl
1let userID = "86c50e3a-5b87-49dd-bd20-03c7f2735e40"; //可以把86c50e3a-5b87-49dd-bd20-03c7f2735e40改为你自定义的uuid2const proxyIPs = [""]; //""之间填写proxyip，留空将无法访问CF网站
```
...
```java
1let userID = "20a4537b-8da9-4bd4-b666-6e29a62345f7";2const proxyIPs = ["ProxyIP.US.CMLiussss.net"];
```
...
## 访问 Worker[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E8%AE%BF%E9%97%AE-worker)
...
## 编写 Clash 规则[#](https://blog.adclosenn.top/posts/cloudflare-workers-proxy/#%E7%BC%96%E5%86%99-clash-%E8%A7%84%E5%88%99)
...
```perl
1vless://20a4537b-8da9-4bd4-b666-6e29a62345f7@www.visa.com.sg:8443?encryption=none&security=tls&type=ws&host=xxx.dpdns.org&sni=xxx.dpdns.org&fp=random&path=%2F%3Fed%3D2560#xxx.dpdns.org
```
...
```perl
1vless://20a4537b-8da9-4bd4-b666-6e29a62345f7@cf.090227.xyz:8443?encryption=none&security=tls&type=ws&host=xxx.dpdns.org&sni=xxx.dpdns.org&fp=random&path=%2F%3Fed%3D2560#xxx.dpdns.org
```
